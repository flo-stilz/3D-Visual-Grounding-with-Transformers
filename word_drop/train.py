...
if __name__ == "__main__":
    ...
    # proposal module
    parser.add_argument("--proposal_module", type=str, default='scanrefer', help="Proposal modules: scanrefer, dvg")
    # 3DETR optimizer
